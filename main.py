...
class TestUrbanRoutes:
    ...
    def test_select_plan(self):
        # Adicionar em S8
        print("Função criada para selecionar plano de viagem")
        pass
    ...
    def test_comment_for_driver(self):
        # Adicionar em S8
        print("Função criada para preencher comentário para motorista")
        pass
    ...
    def test_order_2_ice_creams(self):
        ...
        for count in range(number_of_ice_creams):
            # Adicionar em S8
            print("Função criada para solicitar um sorvete")
        pass
